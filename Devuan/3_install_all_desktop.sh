...
/usr/bin/apt-get install amd64-microcode -y
...
/usr/bin/apt-get install -f -y
/usr/bin/apt-get install r-recommended yapf3 python3-biopython jupyter-notebook python3-pandas python3-keyring python3-seaborn python3-sklearn flake8 -y
cd /tmp
